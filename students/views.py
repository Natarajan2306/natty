		...
		return redirect('home')
			...
			if request.method == 'POST':
				...
				if form.is_valid():
					...
					return render(request, '/Users/hysntechnologies/Downloads/Database/import/student_database/students/templates/login.html')
			...
			context = {'form':form}
			return render(request, '/Users/hysntechnologies/Downloads/Database/import/student_database/students/templates/Register.html', context)
...
def loginpage(request):
	if request.user.is_authenticated:
		return redirect('home')
			...
			context = {}
			return render(request, '/Users/hysntechnologies/Downloads/Database/import/student_database/students/templates/login.html', context)
